...
SELECT MONTHNAME(Date_of_Journey) AS month, COUNT(*) AS no_of_flights
FROM flights
GROUP BY MONTHNAME(Date_of_Journey)
ORDER BY COUNT(*) DESC LIMIT 1;
-- June Month has higher number of flights
---------------------------------------------------------------------------------------------------------------


---------------------------------------------------------------------------------------------------------------
-- 	2. Which week day has most costly flights
SELECT DAYNAME(Date_of_Journey) dayname, ROUND(AVG(price),2) avg_price FROM flights
GROUP BY DAYNAME(Date_of_Journey)
ORDER BY avg_price DESC LIMIT 1;
-- Thursday has most costly flights
---------------------------------------------------------------------------------------------------------------


---------------------------------------------------------------------------------------------------------------
-- 3. Find number of indigo flights every month
SELECT MONTHNAME(date_of_journey) month,COUNT(*) no_of_indigo_flights FROM flights
...
SELECT COUNT(*) no_of_Flights FROM flights
...
SELECT airline,QUARTER(departure) quarter,COUNT(*) no_of_flights
FROM flights
